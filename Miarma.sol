...
contract Miarma is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Miarma";
    string constant _symbol = "MIAR";
    uint8 constant _decimals = 8;

    uint256 _totalSupply = 1000000000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply.div(200); // 0.5% = 5000000000000 MIAR
    uint256 public _maxWallet = _totalSupply.div(100); // 1% = 10000000000000 MIAR
    ...
    address public marketingAddress = 0x76017db4adf63a9dB1989deC0fF400499e573DAd;
    address public devAddress = 0x54C7dAB6E324C064821ae11B4aA86dE2D3b49140;

    uint256 liquidityFee = 230; // 2,3%
    uint256 buybackFee = 0;
    uint256 reflectionFee = 150; // 1,5%
    uint256 marketingFee = 10; // 0.10%
    uint256 devFee = 10; // 0.10%
    uint256 totalFee = 400; // 4% Feed
    ...
    uint256 public swapThreshold = 100000000000 * (10 ** _decimals);
    bool inSwap;
    ...
    function swapBack() internal swapping {
        ...
        payable(devAddress).transfer(amountBNBDev);
        ...
        // Send BNB to marketingAddressWallet
    ...
    function setFees(uint256 _liquidityFee, uint256 _buybackFee, uint256 _reflectionFee, uint256 _devFee, uint256 _marketingFee, uint256 _feeDenominator) external authorized {
        liquidityFee = _liquidityFee;
        buybackFee = _buybackFee;
        reflectionFee = _reflectionFee;
        devFee = _devFee;
        marketingFee = _marketingFee;
        totalFee = _liquidityFee.add(_buybackFee).add(_reflectionFee).add(_devFee).add(_marketingFee);
        feeDenominator = _feeDenominator;
        require(totalFee < feeDenominator/4);
    }

    function setFeeReceivers(address _autoLiquidityReceiver, address _devAddress, address _marketingAddress) external authorized {
